...
export const seedTaskDetail: TaskDetail = {
  ...
  fileChanges: [
    { id: "fc-1", taskId: "task-gomoku", name: "app.js", language: "javascript", diffAdd: 471, diffDel: 0 },
    { id: "fc-2", taskId: "task-gomoku", name: "index.html", language: "html", diffAdd: 62, diffDel: 6 },
    { id: "fc-3", taskId: "task-gomoku", name: "styles.css", language: "css", diffAdd: 201, diffDel: 1 },
  ],
  checklist: [
    { id: "ci-1", taskId: "task-gomoku", text: "Adapt board scaling and portrait/landscape layout for mobile", done: true, order: 0 },
    { id: "ci-2", taskId: "task-gomoku", text: "Add rules copy, restart entry points, and empty-state guidance", done: true, order: 1 },
    { id: "ci-3", taskId: "task-gomoku", text: "Score candidate moves using offensive/defensive heuristics", done: true, order: 2 },
    { id: "ci-4", taskId: "task-gomoku", text: "Add optional AI focus-area overlay showing considered points", done: true, order: 3 },
    { id: "ci-5", taskId: "task-gomoku", text: "Remove external web font dependency for offline play", done: true, order: 4 },
  ],
};
...
export function buildTaskDetail(task: WorkspaceTask): TaskDetail {
  ...
  const files: TaskDetail["fileChanges"] = [
    { id: `${task.id}-f1`, taskId: task.id, name: "README.md", language: "markdown", diffAdd: 18, diffDel: 2 },
    { id: `${task.id}-f2`, taskId: task.id, name: "index.ts", language: "typescript", diffAdd: 94, diffDel: 11 },
    { id: `${task.id}-f3`, taskId: task.id, name: "styles.css", language: "css", diffAdd: 42, diffDel: 5 },
  ];
